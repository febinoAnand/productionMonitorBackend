...
select_date = datetime(2024,9,19)
machine_id = "M018"
shift = 3
...
###reference print
allProductiondata = ProductionData.objects.filter(production_date = select_date,shift_number = shift, machine_id = machine_id).order_by('timestamp')
